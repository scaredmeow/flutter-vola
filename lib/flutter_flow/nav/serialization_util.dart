  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case SportLeaguesRow:
            return SportLeaguesRow(data);
          case GameDetailsRow:
            return GameDetailsRow(data);
          case AlembicVersionRow:
            return AlembicVersionRow(data);
          case CommentsRow:
          ...
          case SportOrganizationsRow:
            return SportOrganizationsRow(data);
          case GamesRow:
