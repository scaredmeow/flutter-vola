...
class CreateATeamModel extends FlutterFlowModel<CreateATeamWidget> {
  ...
  // Stores action output result for [Backend Call - API (Create a new team)] action in Button widget.
