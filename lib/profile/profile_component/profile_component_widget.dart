  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: FutureBuilder<List<UserProfilesRow>>(
        future: FFAppState().currentUser(
          uniqueQueryKey: 'current_user_$currentUserUid',
          overrideCache: true,
        ...
        builder: (context, snapshot) {
          ...
          List<UserProfilesRow> columnUserProfilesRowList = snapshot.data!;
          final columnUserProfilesRow = columnUserProfilesRowList.isNotEmpty
              ? columnUserProfilesRowList.first
              : null;
          return InkWell(
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.firstNameTextController ??=
                        ...
                        text: columnUserProfilesRow?.firstName,
                      ),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.middleNameTextController ??=
                          TextEditingController(
                        text: columnUserProfilesRow?.middleName,
                      ),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.lastNameTextController ??=
                          TextEditingController(
                        text: columnUserProfilesRow?.lastName,
                      ),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.phoneNumberTextController ??=
                          TextEditingController(
                        text: columnUserProfilesRow?.phoneNumber,
                      ),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.genderTextController ??=
                          TextEditingController(
                        text: columnUserProfilesRow?.gender,
                      ),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.birthdateTextController ??=
                          TextEditingController(
                        text: columnUserProfilesRow?.birthdate?.toString(),
                      ),
