                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Connect with Your Sports Tribe',
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 12.0, 0.0, 0.0),
                              child: Text(
                                'Find fellow fans, discuss the latest games, and share your passion with a community that gets it.',
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 12.0, 0.0, 0.0),
                              child: Text(
                                'Share your hot takes, game predictions, and in-the-moment reactions. Let your sports voice be heard on vola!',
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 12.0, 0.0, 0.0),
                              child: Text(
                                'Get real-time scores, news, and highlights for your favorite teams and leagues. Stay in the game with vola.',
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                            ...
                            children: [
                              Padding(
                                ...
                                child: CachedNetworkImage(
                                  ...
                                  imageUrl:
                                      'https://jvkmtyoxcclkryubmnkh.supabase.co/storage/v1/object/public/vola_public/blue_239e111b-3e09-48be-9dbe-b705caad3ba4%20(1).png?t=2024-04-29T20%3A08%3A29.177Z',
                                  width: 212.0,
                                  height: 201.0,
                                  fit: BoxFit.fitWidth,
                                ).animateOnPageLoad(animationsMap[
